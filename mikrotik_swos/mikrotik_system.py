...
class Mikrotik_System(Swostab):
    ...
    def set(self, **kwargs):
        ...
        self._update_data("allp", utils.encode_listofflags(allow_from_port))
        ...
        self._update_data("igfl", utils.encode_listofflags(igmp_fast_leave))
        self._update_data("dtrp", utils.encode_listofflags(dhcp_trusted_port))
        ...
        if self.version >= 2.17:
            ...
            self._update_data("pdsc", utils.encode_listofflags(discovery_protocol))
        else:
